...
RSpec.feature 'pets/index', type: :system do
  ...
  given!(:pet1) do
    FactoryBot.create(:pet,
                      user: user, name: 'アルク', race: '猫', sex: true, birthday: '2019/5/5', greeted_on: '2019/6/11',
                      note: "毛色: 茶白\n瞳の色: イエロー\n茶トラ系 わんぱく甘えん坊 オス", color: '#ffd900')
  end
  given!(:pet2) do
    FactoryBot.create(:pet,
                      user: user, name: 'スピカ', race: '猫', sex: false,  birthday: '2019/5/5', greeted_on: '2019/6/11',
                      note: "毛色: 灰青\n瞳の色: イエロー\nロシアンブルー系 お嬢様 メス", color: '#5654a2')
  end
  given!(:pet3) do
    FactoryBot.create(:pet,
                      user: user, name: 'リア', race: '猫', sex: false, birthday: '2019/5/5', greeted_on: '2019/6/11',
